...
* Sử dụng phím tắt `<Ctrl>` + ``` để loại trừ ứng dụng không dùng bộ gõ, chuyển qua lại giữa các chế độ gõ: Preedit (default), Surrounding text, IBus forward key event, X11 fake backspace
